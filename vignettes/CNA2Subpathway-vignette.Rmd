...
<font face="微软雅黑"> The function **getCNADEscore** used to calculate CNA-DEscore for each gene, that via Student's t-test to computed t scores and than standardized them to a normal distribution with a mean of 0 and an SD of 1. We classify samples of gene expression data based on copy number Alteration. This function requires the user input the gene expression profile(GEP) and the CNA label(the result of the function getCNAlabel).
